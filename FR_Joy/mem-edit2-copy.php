...
$mid = isset($_GET['mid']) ? intval($_GET['mid']) : 2; //從mid的序號開始
										...
										<div class="m-sm-4">
											<form name="form1" method="post" novalidate onsubmit="checkForm(); return false;">
												...
												<div class="mb-3">
													...
													<input class="form-control form-control-lg" type="text" id="name" name="Mname" required value="<?= $row['Mname'] ?>" />
												</div>
												<div class="mb-3">
													<label for="identity">身分證</label>
													<input class="form-control form-control-lg" type="text" id="identity" name="Midentity"<?= $row['Midentity'] ?>">
												</div>
												<div class="mb-3">
												...
												<input type="radio" id="single" name="Mmarry" value="未婚">
												<label for="single">未婚</label>
												</div>

												<div class="mb-3">
												<label class="form-label">有無子嗣</label>
												<input type="radio" id="have" name="Mchild" value="有小孩">
												<label for="have">有小孩</label>
												<input type="radio" id="havent" name="Mchild" value="無小孩">
