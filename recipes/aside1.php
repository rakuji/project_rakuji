...
<!-- aside1.php 套用於recipes_list.php and recipes_add.php -->
    <div>
        ...
        <div class="collapse" id="collapseExample3">
            <div class="card-body">
                <a href="recipes_list.php" class="list-group-item list-group-item-action <?= $pageName == 'recipes_list'  ? 'active' : '' ?>">食譜查詢</a>
