...
<div class="">
    ...
    <!-- aside2.php 套用於food_list.php and food_add.php -->
    <div>
        <a class="btn list-group-item list-group-item-action aside_btn <?= ($pageName == 'food_list' or $pageName == 'food_add') ? 'active' : '' ?>" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
            <i class="fa-solid fa-caret-right"></i>創意食譜系統
        </a>
        <div class="collapse" id="collapseExample3">
            <div class="card-body">
                <a href="recipes_list.php" class="list-group-item list-group-item-action <?= $pageName == 'food_list'   ? 'active' : '' ?>">食譜查詢</a>
