...
('CH-001',	'綜合樂食寶寶粥組(28入/4盒)',	'寶寶粥食品28入(心干貝貝粥7入,乖乖豬豬粥7入,原淬寶寶粥7入,南瓜飽飽粥7入)',	2000,	1,	9,	NULL,	0,	1),
('CH-002',	'心干貝貝粥7入/盒',	'最多網友好評推薦的常溫寶寶粥',	420,	1,	8,	NULL,	0,	1),
('CH-003',	'乖乖豬豬粥7入/盒',	'純天然、無添加，用愛烹煮的美味',	420,	1,	8,	NULL,	0,	1),
('CH-004',	'南瓜飽飽粥7入/盒',	'優質蛋白質搭配多色蔬果，營養均衡',	420,	1,	8,	NULL,	0,	1),
('CH-005',	'原淬寶寶粥7入/盒',	'公開檢驗報告，從原料製程到成品都安心',	420,	1,	8,	NULL,	0,	1),
('MA-001',	'日式溏心蛋沙拉',	'日式醬油糖心蛋佐清爽生菜',	59,	4,	1,	'',	100,	1),
('MB-001',	'黃金豬排丼飯',	'台灣人氣No.1重磅級豬排',	210,	4,	1,	'',	850,	1),
('MB-002',	'唐揚雞歐姆蛋咖哩飯',	'本店人氣No.1,保證好吃,8種食材精心熬製咖哩醬',	199,	4,	1,	'',	600,	1),
('PG-001',	'日式咖哩調理包',	'8種食材精心熬製咖哩醬…',	150,	1,	2,	'',	700,	1),
('PG-002',	'骰子牛調理包',	'日式和牛肉….',	680,	1,	2,	'',	1200,	1),
('PG-003',	'冷凍可樂餅',	'酥炸可樂餅急凍冷藏，保留香酥美味...(每包6顆)',	180,	1,	2,	'',	900,	1);
...
CREATE TABLE `view_product` (`product_id` varchar(10), `product_name` varchar(50), `product_desc` varchar(100), `product_price` int, `period_name` varchar(10), `product_cal` int);
