        ...
        <div class="col-12 col-md-10">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row" name="form1" method="post" novalidate onsubmit="checkForm(); return false;">
                        <!-- <div class="row"> -->
                        <div class="mb-3 col-6">
                            <label for="pn" class="form-label">品號</label>
                            <input type="text" class="form-control" name="p_id" value="<?= $row['product_id'] ?>" readonly>
                        ...
                        <div class="mb-3 col-6">
                            <label for="p_image" class="form-label">照片</label>
                            <input class="form-control" type="file" id="p_image" name="p_image">
                        </div>
                        <button class="btn btn-primary col-1" type="submit">修改</button>
                    </form>
                </div>
            </div>
            <!-- </div> -->
